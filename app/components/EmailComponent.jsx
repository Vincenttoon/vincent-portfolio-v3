...
const EmailSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const data = {
      email: (form as any).user_email.value, // name="user_email"
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/Vincenttoon" aria-label="GitHub">
            <Image src="/github-icon.svg" alt="Github Icon" width={28} height={28} className="hover:bg-gradient-to-r hover:from-yellow-300 hover:via-blue-400 hover:to-red-500" />
          </Link>
          <Link href="https://www.linkedin.com/in/vincent-toon-4954b6162/" aria-label="LinkedIn">
            <Image src="/linkedin-icon.svg" alt="Linkedin Icon" width={28} height={28} className="hover:bg-gradient-to-r hover:from-yellow-300 hover:via-blue-400 hover:to-red-500" />
          </Link>
        </div>
      </div>
