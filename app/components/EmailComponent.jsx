          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                id="subject"
                required
                className="bg-[#18191E] border border-[#33353F hover:bg-white border placeholder-[#9CA2A9] hover:text-black text-gray-100 text-sm rounded-lg block w-full p-2.5"
            ...
            <div className="mb-6">
              ...
              <textarea
                name="message"
                id="message"
                className="bg-[#18191E] hover:bg-white border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 hover:text-black active:text-black text-sm rounded-lg block w-full p-2.5"
                placeholder="..."
              />
            </div>
            <button
